package com.abdelhadi.vesrion_1_app.user.Station_transport;
...
public class Station_transport_Categorie extends AppCompatActivity {
    ImageView raidfes,maisonbleu,laarosa,jnan,faraj,backBtn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_station_transport_categorie);
        ...
        raidfes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(Station_transport_Categorie.this, raid.class);
        ...
        laarosa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(Station_transport_Categorie.this, larousa.class);
                startActivities(new Intent[]{intent2});
            }
        });
        jnan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(Station_transport_Categorie.this, com.abdelhadi.vesrion_1_app.user.Hotel.jnan.class);
                startActivities(new Intent[]{intent2});
        ...
        faraj.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(Station_transport_Categorie.this, com.abdelhadi.vesrion_1_app.user.Hotel.faraj.class);
                startActivities(new Intent[]{intent2});
            }
        });
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Station_transport_Categorie.super.onBackPressed();
            }
        });
    }
